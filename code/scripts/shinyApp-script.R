...
ui = fluidPage(
	...
	selectInput(inputId = 'intendedMajor', label = 'Choose an intended major', choices = NA),
	# Select financial aid level
	selectInput(inputId = 'financialAid', label = 'Choose a financial aid level', choices = NA)
	# Select 
	)

...
location of all schools in the dataset

![Schools Map](../images/ggmap-schoolDistribution.png)

## EDA - Geo

* geographic location for schools included  





* Minor shortcoming: more data available for public schools

## EDA - Net Price

Net price:  

* final cost of attending an institution (tuition, fees, books, supplies, living expenses)

* stratified by income brackets. 

![](../images/net-price-table.png)

## EDA - Net 

* Net Price: Private Colleges > Public Colleges.

* Net price is included since it represents the **final cost** of attendance after financial aid for each income bracket. 

## EDA - Wrapup

* Only two of the variables considered 

* Other variables were explored but not used. Researches done on them were also considered

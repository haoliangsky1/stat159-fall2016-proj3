...
```{r, echo=FALSE,message=FALSE, fig.align ='center', eval = T, results='asis'}
...
```{r, out.width = "250px", echo=FALSE,message=FALSE, fig.align ='center', eval = T, results='asis'}
...
### Net Price
```{r, out.width = "150px", echo=FALSE,message=FALSE, fig.align ='center', eval = T, results='asis'}
